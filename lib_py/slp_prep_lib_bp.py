...
import os # Ensure this is present at the top of the file!

# --- THE ABSOLUTE PATH FIX ---
# Find the directory of the currently executing script (lib_py)
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))

# Construct the absolute path to FILEPATH.txt by going up one directory
FILEPATH_LOC = os.path.join(SCRIPT_DIR, '..', 'FILEPATH.txt')

# Open the file using the derived absolute path
